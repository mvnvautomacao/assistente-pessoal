...
const ACTION_SCHEMA = {
  ...
  properties: {
    ...
    description: {
      type: "string",
      description:
        "Descricao curta do gasto (type=expense, type=set_recurring_expense), a descricao JA CONHECIDA de um gasto parcial (type=unknown com likely_intent='expense', se o usuario ja descreveu do que foi mas nao o valor), ou o motivo/observacao geral (type=unknown sem informacao parcial nenhuma).",
    },
    day_of_month: {
      type: "number",
    ...
    date: {
      type: "string",
      description:
        "Data ISO 8601 do gasto (type=expense), o dia especifico a listar (type=list_expenses, so a data), ou o dia JA CONHECIDO (YYYY-MM-DD) de um evento/lembrete parcial (type=unknown com likely_intent='event'/'reminder', se o usuario ja mencionou o dia mas nao o horario, ou vice-versa).",
    },
    time: {
      type: "string",
      description:
