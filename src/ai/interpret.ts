...
const ACTION_SCHEMA = {
  ...
  properties: {
    ...
    topic: {
      type: "string",
      enum: ["expense", "event", "reminder", "budget", "expense_report", "edit_expense", "category", "payment_method"],
      description:
        "So para type=help: sobre qual assunto especifico e a duvida do usuario, pra responder com um exemplo direcionado em vez do catalogo inteiro. Deixe em branco se a pergunta for generica.",
    },
    date: {
      type: "string",
